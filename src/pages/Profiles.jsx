...
const Profiles = () => {
  ...
  return (
    <div>
      ...
      <Pagination/>
      <select onChange={(event)=>dispatch(onChangeDataPerpage(event.target.value))} className='font-madimi mx-3 bg-gray-100 dark:bg-neutral-800 border-2 border-violet-500 rounded-lg p-2 text-[16px] dark:text-white' defaultValue={8}>
